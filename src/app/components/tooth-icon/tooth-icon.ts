...
/**
 * Shared tooth glyph (Lucide "tooth", official path).
 * Used for the brand logo and the root canal service icon,
 * so the mark is always consistent across the page.
 */
@Component({
